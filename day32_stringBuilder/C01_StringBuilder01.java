...
public class C01_StringBuilder01 {
    ...
    //sb deki belli bir index 'deki karakteri silme --> obj.delete(a,b); a dahil b hariç arası siler.  obj.deleteCharAt(a); sadece a karakterini siler
    sb1.delete(3, 7);
    ...
    System.out.println("ozel durum : "+sb2.insert(5, "basarili", 2, 4));//Bugxxsaxxxxxxva cook iscakk burada String ifadeye basarili kelimesini
    																	//2 ve 4 u karakterler arasini yerlestirmis.
    /*
